...
export const fetchPlaceDetails = async (placeId: string, apiKey: string): Promise<PlaceDetailsResponse | null> => {
  ...
  try {
    ...
    let city = findFirst(['locality', 'administrative_area_level_2', 'administrative_area_level_3']);
...
export const fetchPlaceDetailsByCoords = async (
  ...
  try {
    ...
    const city = findFirst(['locality', 'administrative_area_level_2', 'administrative_area_level_3']);

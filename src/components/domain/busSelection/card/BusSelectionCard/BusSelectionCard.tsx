                ...
                4:05 pm
                    ...
                    <View style={{ flex: 1, gap: 15 }}>
                        <View style={styles.place}>
                            <Text variant='bold' style={styles.placeTitle}>{data.pickup?.name}</Text>
                            <Text variant='medium' style={styles.placeSubtitle}>{data.pickup?.address}</Text>
                            <TouchableOpacity style={styles.walkAndTimeContainer} onPress={() => setShowSourceStopImages((prev) => !prev)}>
                                ...
                                <Text variant='semi-bold' style={styles.placeSubtitle}>{data.pickup?.distanceText ?? '-'}</Text>

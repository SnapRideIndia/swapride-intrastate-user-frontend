    ...
    return (
        <>
            <View style={styles.container}>
                ...
                <View>
                    <TextInput title={"Password"} isPhno={false} renderRightIcon={handleRenderRightIcon} onChangeText={(text) => handleChange("password", text)} />
                    <Text style={styles.forgotPassword}>Forgot Password?</Text>
                </View>

                <View style={styles.spacer} />

                <Text style={styles.loginPhno} varient='bold' onPress={handlePressPhno}>Login using phone number</Text>
            </View>

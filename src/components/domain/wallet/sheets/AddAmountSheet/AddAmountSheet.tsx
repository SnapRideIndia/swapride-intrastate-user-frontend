...
export const AddAmountSheet = forwardRef<BottomSheetModal, AddAmountSheetProps>(({ onContinue, isLoading = false }, ref) => {
    ...
    <BottomSheet ref={ref} title="Add Amount" snapPoints={['40%', '50%']}>
      <View style={styles.sheetContent}>
        ...
        <PrimaryButton
          ...
          disabled={isLoading}
          renderRightIcon={isLoading ? () => <ActivityIndicator size="small" color={colors.primaryCtaText} /> : undefined}
        />
      </View>
    </BottomSheet>
  );

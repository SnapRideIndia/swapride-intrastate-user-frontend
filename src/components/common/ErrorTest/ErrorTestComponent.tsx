...
const ErrorTestComponent = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Click the button below to trigger an error and test the error boundary</Text>
      <TouchableOpacity style={styles.button} onPress={() => setShouldThrow(true)}>
